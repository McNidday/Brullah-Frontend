...
const nextConfig = {
  ...
  images: {
    domains: ["localhost", "192.168.201.210"],
  },
  env: {
    RELAY_API_ENDPOINT: "http://192.168.201.210:8080",
    BRULLAH_URL: "http://192.168.201.210:3000/",
    CHECKERS_URL: "http://192.168.201.210:3002/",
    PAYPAL_CLIENT_ID:
