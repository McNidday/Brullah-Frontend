...
const ENDPOINTS: { [key: string]: string } = {
  ...
  DepositTransactions: "payments",
  PayoutTransactions: "payments",
  TournamentTransactions: "payments",
  UpdateStartDate: "tournaments",
  GetMyTournaments: "tournaments",
  RemoveFromTournament: "tournaments",
  GetTournament: "public/tournaments",
  GetArenaWinner: "public/tournaments",
  GetMatch: "public/tournaments",
  GetPlayerMatch: "public/tournaments",
  AddToTournament: "tournaments",
  SaveMatchConfig: "tournaments",
  PublishTournament: "tournaments",
  JoinedNotStartedTournaments: "tournaments",
  UserOngoingTournaments: "tournaments",
